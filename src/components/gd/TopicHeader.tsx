...
export function TopicHeader({ topic, timeRemaining, isRecording }: TopicHeaderProps) {
  ...
  return (
    <motion.div
      ...
      className="flex items-center justify-between p-4 bg-card rounded-2xl shadow-md"
    >
      {/* Topic */}
      <div className="flex items-center gap-3 flex-1">
        ...
        <div>
          <p className="text-xs text-muted-foreground font-medium uppercase tracking-wide">Discussion Topic</p>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className={`flex items-center gap-2 px-4 py-2 rounded-xl ${
          isLowTime ? 'bg-destructive/10 text-destructive' : 'bg-muted/50 text-foreground'
        }`}>
